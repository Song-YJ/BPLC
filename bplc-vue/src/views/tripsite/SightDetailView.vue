/**
	* @fileName  : SightDetailView.vue
	* @explain : bplc 웹 사이트 여행지의 명소 detail page
	* @author : 송유진 , yoyo6433@naver.com
	* 부가 설명 : bplc 웹 사이트 여행지의 명소 리스트에서 항목을 선택하면 항목의 detail page View
	*/
    ...
    <div class="contents_back">
        <div class="contents_wrap">
            ...
            <div class="contents">
                ...
                <DetailHead category="명소" :selecteddata="selecteddatainfo"></DetailHead>
                <Likesbtn tablename="sight" :id="$route.params.id"></Likesbtn>
...
export default defineComponent({
  name: 'SightDetailView',
  components:{
      ContentsHead, Category, DetailHead, DetailPhotos, Likesbtn
  },
  data(){
      return{
          selecteddatainfo: {}
  ...
  methods:{
      getSelectInfo: async function(){
          ...
          await axios.get('/dao/detail/sight', {
              params: {
                id: selectedid
              }
          })
          .then(function (response) {
              sdata = response.data;
              sdata.photopath = imagepath.sight[sdata.photopath];
          })
